...
class HomeRepeImple extends HomeRepo {
  ...
  @override
  Future<Either<Failure, List<ProductEntity>>> fetchcategersproduct(categers)async {
    try {
      var productlist =await homeRemoteDataSource.fetchCategersAllproduct(categers);
      return right(productlist);
    }  catch (e) {
      if (e is DioException)
      {return left(servicefailure.fromdioError(e));}
